 ...
 */
public class Vector implements List<ammunition> {
    ...
    public ammunition get(int index) {
        return ( index >= 0 && index < size ) ? container[index] : null;
    }
    ...
    @Override
    public ammunition set (int index, ammunition e) {
    ...
    @Override
    public void add(int index, ammunition e) {
        if (index < 0 || index >= size) {
            return;
        }
